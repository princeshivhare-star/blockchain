...
- Added transaction search UI
- Added blockchain persistence using blockchain.json
- Added validation for search query params

## Known Limitations

- Uses local JSON persistence instead of database
- Search only covers confirmed transactions
